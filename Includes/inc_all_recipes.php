    ...
    if($DBConnect === FALSE)
        ...
        while($row = @mysqli_fetch_assoc($QueryResult)) {
            ...
            echo "<div class='b'><a href='{$url}'>{$name}</a></div>" .
                ...
                //"<input type='submit' name='fave' id=$inc value='Favorite'/></form>";
            //$inc++;
            if($row['alcohol'] == 0)
                echo "<br>";
...
//FIGURE OUT HOW TO GET ISSET TO CHECK FOR AN INDIVIDUAL BUTTON
// if (isset($_POST['fave'])) {
//     if (isset($_SESSION['authenticated']) && $_SESSION['authenticated']==TRUE) {
//         $insert_fave = "INSERT INTO favorites (name, fave_recipes)
//         VALUES ('{$_SESSION["user_id"]}', '$name')";
//         mysqli_query($DBConnect, $insert_fave);
//         echo "<p>Successfully added to favorites!</p>";
//     }
//     else {
//         echo "<p>You must log in to add a favorite recipe.</p>";
//     }
// }
    }
